...
def split_script(text, max_chars=280):
    """Script ကို စာကြောင်းအလိုက် ခွဲ (max_chars အောက်)"""
...
def run_tts_chunked(text, output_path, ref_audio_path=None, progress_callback=None):
    ...
    for i, chunk in enumerate(chunks):
        ...
        result = client.predict(
            ...
            prompt_text="",
            use_ultimate_cloning=(ref_audio_path is not None),
            cfg_value=2.0,
...
# ===== Sidebar — Voice Sample (တစ်ခါပဲ တင်) =====
...
if ref_audio is not None:
    ...
    st.sidebar.success("✅ အသံ သိမ်းပြီး — ပြန်တင်စရာ မလိုဘူး")
